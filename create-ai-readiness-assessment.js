/**
 * Script to create AI Readiness Assessment with all topics and questions
 * Based on the provided HTML assessment form
 */
...
// Create 5-point scale answers for each question
const createAnswersForQuestion = (questionId) => {
  return [
    {
...
async function createAIReadinessAssessment() {
  try {
    console.log('Starting AI Readiness Assessment creation...');
    ...
    console.log('AI Readiness Assessment created successfully!');
